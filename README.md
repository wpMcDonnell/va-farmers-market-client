...
1. Unzip and rename the template directory (`unzip ~/Downloads/va-farmers-market-client-main.zip`).
1. Move into the new project and `git init`.
1. Empty [`README.md`](README.md) and fill with your own content.
1. Replace `va-farmers-market-client` in `package.json` with your
   projects name.
